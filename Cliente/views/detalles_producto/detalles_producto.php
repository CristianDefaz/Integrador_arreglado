            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__pic">
                    <div class="product__details__pic__item">
                        <img class="product__details__pic__item--large" src="<?php echo $ruta_aplicacion; ?>" alt="">
                    </div>
                </div>
            </div>
...
<section class="related-product">
    ...
    LIMIT 4";
        ...
        while ($fila = mysqli_fetch_assoc($resultado)) {
            ...
            $precio = $fila['Precio'];
            $ruta_base_datos = $fila['Imagen'];
            $ruta_aplicacion = "../../Admin/Public/assets/images/products/" . basename($ruta_base_datos);
            $anchoImagen = 250;
            $altoImagen = 150;
