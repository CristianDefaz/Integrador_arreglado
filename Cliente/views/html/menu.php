...
if (!empty($_SESSION['ClienteID'])) {
    ...
    echo '<a href="../views/perfil/perfil.php?ClienteID=' . $clienteID . '"><i class="fa fa-user"></i>' . $nombreCliente . '</a>';
    echo '</div>';
} else {
...
?>
<a href="sesion/logout.php"><i class="fa fa-user"></i> Login</a>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="hero__categories">
                    ...
                    <li><a href="./index.php?page=tienda/tienda&valor=1">RAM</a></li>
                        <li><a href="./index.php?page=tienda/tienda&valor=2">Procesadores</a></li>
                        <li><a href="./index.php?page=tienda/tienda&valor=3">Tarjeta Gráfica</a></li>
                        <li><a href="./index.php?page=tienda/tienda&valor=4">Almacenamiento (HDD/SSD)</a></li>
                        <li><a href="./index.php?page=tienda/tienda&valor=5">Placa Base</a></li>
                        
                        <li><a href="./index.php?page=tienda/tienda&valor=7">Fuente de Poder</a></li>
                        <li><a href="./index.php?page=tienda/tienda&valor=8">Sistema de Refrigeración (Ventiladores/Disipadores)</a></li>
                        <li><a href="./index.php?page=tienda/tienda&valor=9">Case</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-9">
