    ...
    <div class="container">
                ...
                <div class="row">
                    ...
                    if ($busqueda != 'null') {
                        ...
                        $sql .= "  where p.Nombre like '%$busqueda%' or c.Nombre like '%$busqueda%'";
                    }
                    if ($filtrar == 'search') {
                       
                        $sql .= "  WHERE c.Nombre='$componentes' and p.Precio  BETWEEN $minPrecio AND $maxPrecio ORDER BY p.Precio $ordenarPor";
                    }
